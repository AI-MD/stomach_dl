...
ap.add_argument("--model", required=False,
                ...
                default='se_resnet50')
ap.add_argument("--train_dir", required=False, help="train dir", default='./stomach_mid_new_1123/train')
ap.add_argument("--test_dir", required=False, help="test dir", default='./stomach_mid_new_1123/test')
...
# Loss function
criterion = nn.BCEWithLogitsLoss(weight=torch.tensor([30/dataset_sizes['train'],227/dataset_sizes['train'],364/dataset_sizes['train'],
                                         255 / dataset_sizes['train'], 310 / dataset_sizes['train'], 316 / dataset_sizes['train']
                                         ,275 / dataset_sizes['train'],303 / dataset_sizes['train']]).to(device))
