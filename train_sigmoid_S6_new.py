...
ap.add_argument("--model", required=False,
                ...
                default='se_resnet50')
ap.add_argument("--train_dir", required=False, help="train dir", default='./stomach_mid_new_0503/train')
ap.add_argument("--test_dir", required=False, help="test dir", default='./stomach_mid_new_0503/test')
...
# Loss function
criterion = nn.BCEWithLogitsLoss(weight=torch.tensor([46/dataset_sizes['train'],364/dataset_sizes['train'],636/dataset_sizes['train'],
                                         344 / dataset_sizes['train'], 413 / dataset_sizes['train'], 414 / dataset_sizes['train']
                                         ,380 / dataset_sizes['train'],463 / dataset_sizes['train'], 100 / dataset_sizes['train']]).to(device))
